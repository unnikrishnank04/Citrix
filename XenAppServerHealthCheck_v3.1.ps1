...
## Script modified by unnikkri@in.ibm.com, 
## ##
...
$emailFrom     = "ukunthanipotta@statestreet.com"
$emailTo       = "ukunthanipotta@statestreet.com"
$smtpServer    = "ukunthanipotta@statestreet.com"
